...
module GameServer
  struct CoordinateLog
    ...
    def initialize(@coordinates : Array(Int32), @player : String? = nil, @spells_cast = [] of Spell, @attributes = CoordinateAttributes.new)
    end
  ...
  struct GameState
    ...
    def initialize(@log = [] of CoordinateLog, @players = {} of String => Player, @coordinate_attributes = {} of String => CoordinateAttributes)
    end
